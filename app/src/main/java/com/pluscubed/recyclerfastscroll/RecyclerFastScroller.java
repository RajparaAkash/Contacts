...
//                    new InsetDrawable(new ColorDrawable(mHandleNormalColor), mBarInset, 0, 0, 0));
            ...
            drawable.addState(View.PRESSED_ENABLED_STATE_SET,
                    getContext().getDrawable(R.drawable.contact_bg_scroll_thumb_press));
            drawable.addState(View.EMPTY_STATE_SET,
                    getContext().getDrawable(R.drawable.contact_bg_scroll_thumb));
...
//        }
        drawable = getContext().getDrawable(R.drawable.contact_bg_scroll_trans);
