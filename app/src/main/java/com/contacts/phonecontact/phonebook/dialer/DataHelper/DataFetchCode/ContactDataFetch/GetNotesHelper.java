...
public class GetNotesHelper {

    public static SparseArray invoke$default(GetNotesHelper getNotesUseCase, Context context, Integer num, ArrayList arrayList, int i, Object obj) {
        if ((i & 2) != 0) {
            num = null;
        }
        if ((i & 4) != 0) {
        ...
        return getNotesUseCase.invoke(context, num, arrayList);
    }
    ...
    public SparseArray<ArrayList<String>> invoke(Context context, Integer num, ArrayList<String> arrayList) {
        ...
        if (num == null) {
            strArr = BasicUtils.getSourcesSelectionArgs1$default("vnd.android.cursor.item/note", null, arrayList, 2, null);
        } else {
