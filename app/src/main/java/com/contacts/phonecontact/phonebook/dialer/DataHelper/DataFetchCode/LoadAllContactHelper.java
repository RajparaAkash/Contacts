...
public class LoadAllContactHelper {
    private final ContactOrder contactOrder;
    private final ContactRepo contactRepo;
    private final Context mContext;
    private final FilterType mFilterType;

    public LoadAllContactHelper(Context context, ContactRepo contactRepo2, ContactOrder contactOrder2, FilterType filterType) {
    ...
    public List<Contact> invoke() {
        ...
        Integer num7 = null;
        Integer num8 = null;
        List<Contact> allContacts = contactRepo.getAllContacts();
        ...
        if (i == 1) {
            ...
            if (sortingType instanceof SortingType.Ascending) {
                if (contactOrder instanceof ContactOrder.Title) {
                    ...
                    if (Intrinsics.areEqual(orCreateKotlinClass, Reflection.getOrCreateKotlinClass(Integer.TYPE))) {
                        ...
                        num4 = contactAppPreference.getInt(string, i7);
                    }
                    if (num4 == ContactNameFormatType.FIRST_NAME_FIRST.getSelectedType()) {
                        return CollectionsKt.sortedWith(allContacts, new Comparator<Contact>() {
                            @Override
                ...
                Integer valueOf2 = ContactNameFormatType.FIRST_NAME_FIRST.getSelectedType();
                KClass orCreateKotlinClass2 = Reflection.getOrCreateKotlinClass(Integer.class);
                if (Intrinsics.areEqual(orCreateKotlinClass2, Reflection.getOrCreateKotlinClass(Integer.TYPE))) {
                    if (valueOf2 != null) {
                        i8 = valueOf2;
                    }
                    num3 = contactAppPreference2.getInt(string3, i8);
                }
                if (num3 == ContactNameFormatType.FIRST_NAME_FIRST.getSelectedType()) {
                    return CollectionsKt.sortedWith(allContacts, new Comparator<Contact>() {
                        @Override
                        public int compare(Contact t, Contact t2) {
                            String lowerCase = t.getFirstNameOriginal().toLowerCase(Locale.ROOT);
                ...
                if (Intrinsics.areEqual(orCreateKotlinClass3, Reflection.getOrCreateKotlinClass(Integer.TYPE))) {
                    ...
                    num2 = contactAppPreference3.getInt(string5, i9);
                }
                if (num2 == ContactNameFormatType.FIRST_NAME_FIRST.getSelectedType()) {
                    return CollectionsKt.sortedWith(allContacts, new Comparator<Contact>() {
                        @Override
                        public int compare(Contact t, Contact t2) {
                ...
                Integer valueOf4 = ContactNameFormatType.FIRST_NAME_FIRST.getSelectedType();
                KClass orCreateKotlinClass4 = Reflection.getOrCreateKotlinClass(Integer.class);
                if (Intrinsics.areEqual(orCreateKotlinClass4, Reflection.getOrCreateKotlinClass(Integer.TYPE))) {
                    if (valueOf4 != null) {
                        i2 = valueOf4;
                    }
                    num = contactAppPreference4.getInt(string7, i2);
                }
                if (num == ContactNameFormatType.FIRST_NAME_FIRST.getSelectedType()) {
                    return CollectionsKt.sortedWith(allContacts, new Comparator<Contact>() {
                        @Override
                        public int compare(Contact t, Contact t2) {
                            String lowerCase = t2.getFirstNameOriginal().toLowerCase(Locale.ROOT);
            ...
            if (sortingType2 instanceof SortingType.Ascending) {
                if (contactOrder instanceof ContactOrder.Title) {
                    ...
                    Integer valueOf5 = ContactNameFormatType.FIRST_NAME_FIRST.getSelectedType();
                    KClass orCreateKotlinClass5 = Reflection.getOrCreateKotlinClass(Integer.class);
                    if (Intrinsics.areEqual(orCreateKotlinClass5, Reflection.getOrCreateKotlinClass(Integer.TYPE))) {
                        if (valueOf5 != null) {
                            i3 = valueOf5;
                        }
                        num8 = contactAppPreference5.getInt(string9, i3);
                    }
                    if (num8 == ContactNameFormatType.FIRST_NAME_FIRST.getSelectedType()) {
                ...
                Integer valueOf6 = ContactNameFormatType.FIRST_NAME_FIRST.getSelectedType();
                ...
                if (Intrinsics.areEqual(orCreateKotlinClass6, Reflection.getOrCreateKotlinClass(Integer.TYPE))) {
                    ...
                    num7 = contactAppPreference6.getInt(string11, i4);
                }
                if (num7 == ContactNameFormatType.FIRST_NAME_FIRST.getSelectedType()) {
                    return CollectionsKt.sortedWith(arrayList, new Comparator<Contact>() {
                        @Override
                        public int compare(Contact t, Contact t2) {
                            String lowerCase = t.getFirstNameOriginal().toLowerCase(Locale.ROOT);
                ...
                Integer valueOf7 = ContactNameFormatType.FIRST_NAME_FIRST.getSelectedType();
                ...
                if (Intrinsics.areEqual(orCreateKotlinClass7, Reflection.getOrCreateKotlinClass(Integer.TYPE))) {
                    ...
                    num6 = contactAppPreference7.getInt(string13, i5);
                }
                if (num6 == ContactNameFormatType.FIRST_NAME_FIRST.getSelectedType()) {
                    return CollectionsKt.sortedWith(arrayList, new Comparator<Contact>() {
                        @Override
                        public int compare(Contact t, Contact t2) {
                            String lowerCase = t2.getFirstNameOriginal().toLowerCase(Locale.ROOT);
                ...
                Integer valueOf8 = ContactNameFormatType.FIRST_NAME_FIRST.getSelectedType();
                ...
                if (Intrinsics.areEqual(orCreateKotlinClass8, Reflection.getOrCreateKotlinClass(Integer.TYPE))) {
                    ...
                    num5 = contactAppPreference8.getInt(string15, i6);
                }
                if (num5 == ContactNameFormatType.FIRST_NAME_FIRST.getSelectedType()) {
                    return CollectionsKt.sortedWith(arrayList, new Comparator<Contact>() {
                        @Override
                        public int compare(Contact t, Contact t2) {
                            String lowerCase = t2.getFirstNameOriginal().toLowerCase(Locale.ROOT);
